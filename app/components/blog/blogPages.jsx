...
let posts = [
    {
        title: 'Building a Physics Engine, Pt. 9 - Diversion 1: Visualizing Our System for Debugging',
        id: 'physengine9',
        url: 'physengine9',
        last: 'physengine8',
        next: 'physengine10',
        content: (
            <div>
                <h2>Building a Physics Engine, Pt. 9 - Diversion 1: Visualizing Our System for Debugging</h2>
...
`}</SyntaxHighlighter>
    ...
    {
        title: 'Building a Physics Engine, Pt. 8 - Spatial Subdivision',
        id: 'physengine8',
        url: 'physengine8',
        last: 'physengine7',
        next: 'physengine9',
